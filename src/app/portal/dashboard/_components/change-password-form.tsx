...
import { updateClientPassword } from "@/lib/actions/portal-actions"
...
export function ChangePasswordForm({ variant = "default" }: { variant?: "default" | "dropdown" }) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-[calc(100%+0.5rem)] z-[100] bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/40 rounded-2xl p-4 w-[280px]" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.04)' }}>
